...
import Scene from "@decode/seeds/gauge";
type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");
const SCRIPT = "The gauge shows CPU usage sitting at seventy-two percent.";
const STEP = 0.36;
...
export const GAUGE_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.6) * 30);
const CUES = new Set(["gauge", "usage"]);
