...
import Scene from "@decode/seeds/pie-chart";
type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");
const SCRIPT = "Mobile takes the biggest share, then desktop, and tablet is the smallest slice.";
const STEP = 0.36;
...
export const PIE_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.9) * 30);
const CUES = new Set(["share", "pie"]);
