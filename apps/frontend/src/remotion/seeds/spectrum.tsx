...
import Scene from "@decode/seeds/spectrum";

type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");

const SCRIPT =
  "It is a balance. Too simple and the model has high bias. Too complex and high variance. We want the sweet spot.";
const STEP = 0.3;
...
export const SPECTRUM_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.4) * 30);
const CUES = new Set(["balance"]);
