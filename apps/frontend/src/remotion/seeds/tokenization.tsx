...
import Scene from "@decode/seeds/tokenization";
type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");
const SCRIPT = "Tokenization splits the word unbreakable into three subword tokens.";
const STEP = 0.34;
...
export const TOKENIZATION_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.6) * 30);
const CUES = new Set(["tokens", "split"]);
