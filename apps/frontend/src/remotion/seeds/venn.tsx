...
import Scene from "@decode/seeds/venn";
type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");
const SCRIPT = "Frontend and backend overlap in the middle. That overlap is full-stack, doing both.";
const STEP = 0.36;
...
export const VENN_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.5) * 30);
const CUES = new Set(["overlap", "both"]);
export function VennPreview() {
