...
import Scene from "@decode/seeds/quote";
type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");
const SCRIPT = "Premature optimization is the root of all evil, as Donald Knuth put it.";
const STEP = 0.34;
...
export const QUOTE_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.6) * 30);
