...
import Scene from "@decode/seeds/stack";

type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");

const SCRIPT =
  "A stack grows and shrinks from one end, the top. You push onto the top, and you pop from the top.";
const STEP = 0.3;
...
export const STACK_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.4) * 30);
const CUES = new Set(["stack", "top"]);
