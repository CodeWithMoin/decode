...
import Scene from "@decode/seeds/statement";
...
export const STATEMENT_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.6) * 30);

const CUES = new Set(["weigh", "what", "matters"]);
