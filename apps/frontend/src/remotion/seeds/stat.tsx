...
import Scene from "@decode/seeds/stat";

type Word = { word: string; startInSeconds: number; endInSeconds: number };
const norm = (s: string) => s.toLowerCase().replace(/[^a-z0-9]/g, "");

const SCRIPT = "The largest models have grown to a hundred and seventy five billion parameters.";
const STEP = 0.3;
...
export const STAT_PREVIEW_DURATION = Math.round((WORDS.length * STEP + 1.6) * 30);

const CUES = new Set(["hundred", "billion", "parameters"]);
